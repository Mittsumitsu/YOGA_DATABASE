---
type: index
title: "サンスクリット語彙（Vocabulary）"
description: "ヨーガ哲学・ハタヨーガの主要サンスクリット用語エントリ。IAST表記・語源・出典付き。"
timestamp: 2026-06-15
---

# サンスクリット語彙（Vocabulary）

ヨーガ哲学・ハタヨーガの主要サンスクリット用語エントリ。IAST表記・語源・出典付き。
...
- [ニローダ（Nirodha）](nirodha.md) — ニローダ（Nirodha）のサンスクリット語彙エントリ（IAST: Nirodha）
- [プラーナーヤーマ（prāṇāyāma）](pranayama.md) — プラーナーヤーマ（prāṇāyāma）のサンスクリット語彙エントリ（IAST: prāṇāyāma）
- [ヴリッティ（Vṛtti）](vritti.md) — ヴリッティ（Vṛtti）のサンスクリット語彙エントリ（IAST: Vṛtti）
