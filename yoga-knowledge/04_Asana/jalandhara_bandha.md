...
description: "HYP第3章収録（yoga-asana） — ジャーランダラ・バンダ（jālandhara-bandha）の実践法エントリ"
...
# ジャーランダラ・バンダ（jālandhara-bandha）

## 区分
**区分A — HYP確認済み**（HYP 第3章「The Jalandhara Bandha」）

## 読み
ジャーランダラ・バンダ

## 語源
jāla（ジャーラ / 網・格子）＋ dhara（ダラ / 保持・支える）＋ bandha（バンダ / 締め・錠）。
直訳は「網を保持する締め」。喉のナーディーネットワークを封鎖することに由来する。
...
> The two Nadis should be stopped firmly by contracting the throat. This is called the middle circuit or center (Madhya Chakra), and it stops the 16 adharas (i.e., vital parts).
...
*出典: 05_Sources/HYP_Svatmarama_fulltext.md — Chapter 3, The Jalandhara Bandha*
