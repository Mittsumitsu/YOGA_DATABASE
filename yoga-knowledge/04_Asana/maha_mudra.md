---
type: yoga-asana
title: "マハー・ムドラー（mahā-mudrā）"
description: "HYP第3章収録（yoga-asana） — マハー・ムドラー（mahā-mudrā）の実践法エントリ"
...
hyp_chapter: 3
hyp_section: The Maha Mudra
---

# マハー・ムドラー（mahā-mudrā）

## 区分
**区分A — HYP確認済み**（HYP 第3章「The Maha Mudra」）

## 読み
マハー・ムドラー

## 語源
mahā（マハー / 大いなる・偉大な）＋ mudrā（ムドラー / 印・封印）。
直訳は「大いなる封印」。
...
> It should be expelled then, slowly only and not violently. For this very reason, the best of wise men call it the Maha Mudra. This Maha Mudra has been propounded by great masters.
...
## 解説
第3章（十大ムドラー）の第一。左踵で会陰を押し右足を伸ばして爪先を掴み、Jālandhara Bandhaで喉を閉じながら吸気してクンダリニーをスシュムナーへ導く。
左右交互に等回数行う。
「あらゆる化学物質の有害作用を破壊する」「最猛毒も甘露として作用する」と記される。
[Mahā Bandha](maha_bandha.md)・[Mahā Vedha](maha_vedha.md)と三位一体（「三大秘法」HYP第3章）をなす。
