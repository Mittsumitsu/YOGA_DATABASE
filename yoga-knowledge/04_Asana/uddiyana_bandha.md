...
hyp_chapter: 3
hyp_section: The Uddiyana Bandha
---

# ウッディヤーナ・バンダ（uḍḍīyāna-bandha）

## 区分
**区分A — HYP確認済み**（HYP 第3章「The Uddiyana Bandha」）

## 読み
ウッディヤーナ・バンダ

## 語源
uḍḍīyāna（ウッディヤーナ / 上へ飛ぶ・上昇する）＋ bandha（バンダ / 締め・錠）。
直訳は「上昇の締め」。プラーナ（ヴァーユ）がスシュムナーへ上昇・飛翔することに由来する。
...
## 解説
「すべてのバンダの中で最善」とHYPが明言するバンダ。臍の上下の腹部を背骨に向かって引き込む技法。
「プラーナという大きな鳥がそれに結ばれ疲れずに飛ぶ」という詩的表現が特徴。
