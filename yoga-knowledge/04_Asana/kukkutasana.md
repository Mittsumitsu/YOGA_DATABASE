---
type: yoga-asana
title: "クッカターサナ（kukkuṭāsana）"
description: "HYP第1章収録 — クッカターサナ（kukkuṭāsana）の実践法エントリ"
...
## 解説
[Padmāsana](padmasana.md)（ロータスポーズ）の姿勢をとり、両手を腿の下に差し込んで地面に手のひらをつけ、身体を持ち上げる腕支持のアーサナ。
Padmāsanaを前提とするため、[Uttānakūrmāsana](uttanakurmasana.md)（ウッターナ・クールマーサナ）の基礎とも位置づけられる。
