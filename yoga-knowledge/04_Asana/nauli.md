...
type: yoga-asana
title: "ナウリー（naulī）"
description: "HYP第2章収録（クリヤー（六浄化法）） — ナウリー（naulī）の実践法エントリ"
...
hyp_chapter: 2
hyp_section: The Nauli
---

# ナウリー（naulī）

## 区分
**区分A — HYP確認済み**（HYP 第2章「The Nauli」）

## 読み
ナウリー

## 語源
Sanskrit nālī（「管・筒」）またはnaulī（腹直筋を指す技術用語）に由来する。
...
*出典: 05_Sources/HYP_Svatmarama_fulltext.md — Chapter 2, The Nauli*

## 解説
六浄化法（Ṣaṭ-Karma）の第五。踵を上げてつま先立ちで座り、掌を地につけた屈曲姿勢で腹を左右に強く動かす腹直筋分離の内臓マッサージ法。
消化不良を取り除き、食欲・消化を増進し、すべての不調を乾かすとされ、「ハタ・ヨーガにおける優れた運動」と明言される。
