...
type: yoga-asana
title: "バスティ（basti）"
description: "HYP第2章収録（yoga-asana） — バスティ（basti）の実践法エントリ"
...
hyp_chapter: 2
hyp_section: The Basti
---

# バスティ（basti）

## 区分
**区分A — HYP確認済み**（HYP 第2章「The Basti」）

## 読み
バスティ

## 語源
Sanskrit basti（「膀胱・浣腸」）に由来。
直訳は「浣腸法」。
...
*出典: 05_Sources/HYP_Svatmarama_fulltext.md — Chapter 2, The Basti*

## 解説
六浄化法（Ṣaṭ-Karma）の第二。臍の深さの水中でしゃがみ、管を肛門に挿入して収縮・排出する腸洗浄法。
ヴァータ・ピッタ・カパーの乱れによる病、疝痛・脾臓肥大・水腫を治すとされる。
