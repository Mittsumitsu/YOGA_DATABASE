...
description: "HYP第2章収録（yoga-asana） — ウッジャーイー（ujjāyī）の実践法エントリ"
...
## 区分
**区分A — HYP確認済み**（HYP 第2章「Ujjayi」）

## 読み
ウッジャーイー

## 語源
ud（ウド / 上・外）＋ √ji（ジ / 征服する）＋ -ī（女性形名詞語尾）。
直訳は「上方を征服するもの」または「勝利の呼吸」。
...
*出典: 05_Sources/HYP_Svatmarama_fulltext.md — Chapter 2, Ujjayi*

## 解説
八種のクンバカの第二。喉頭（ナーディーの入口）を閉じ、空気が喉から胸へと触れるように音を立てながら吸気する。呼気は左鼻孔（Iḍā）から行う。
「歩行中・座中を問わずいかなる状態でも行える」とHYPが明記する唯一のクンバカ。
喉の痰・[nāḍī](../01_Vocabulary/nadi.md)の欠陥・水腫・体液（Dhatu）の障害を除くとされる。
