---
type: yoga-asana
title: "シンハーサナ（siṃhāsana）"
description: "HYP第1章収録 — シンハーサナ（siṃhāsana）の実践法エントリ"
tags: [yoga, asana, hatha, hyp]
timestamp: 2026-06-14
sanskrit: siṃhāsana
source: 05_Sources/HYP_Svatmarama_fulltext.md
hyp_chapter: 1
hyp_section: The Simhāsana
---

# シンハーサナ（siṃhāsana）

## 区分
**区分A — HYP確認済み**（HYP 第1章「The Simhāsana」）

## 読み
シンハーサナ

## 語源
siṃha（シンハ / ライオン）＋ āsana（アーサナ / 座法）。
直訳は「ライオンの座法」。
...
> This is Simhāsana, held sacred by the best Yogis and Yoginis. This excellent āsana effects the completion of the three Bandhas (the Mulabandha, Kantha or Jālandhar Bandha and Uddiyāna Bandha).

*出典: 05_Sources/HYP_Svatmarama_fulltext.md — Chapter 1, The Simhāsana*

## 解説
HYPが「四大アーサナ」として特に挙げるうちの一つ（Siddha・Padma・Simha・Bhadraの四つ）。
「最善のヨーギーたちに神聖視される座法」と称される。
三つのバンダ（Mūla Bandha・Jālandhara Bandha・Uḍḍīyāna Bandha）を自然に完成させるとされる点が特徴。
