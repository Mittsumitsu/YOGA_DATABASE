...
hyp_chapter: 2
hyp_section: The Neti
---

# ネーティ（neti）

## 区分
**区分A — HYP確認済み**（HYP 第2章「The Neti」）

## 読み
ネーティ

## 語源
Sanskrit neti（「鼻腔洗浄法」）に由来。語根は不明確だが実践名として定着した技術用語。
...
*出典: 05_Sources/HYP_Svatmarama_fulltext.md — Chapter 2, The Neti*

## 解説
六浄化法（Ṣaṭ-Karma）の第三。約6インチの糸の縄を鼻孔に通し、口から引き出す鼻腔・咽頭洗浄法。
「脳の浄化者・神聖な視力の付与者」と称され、頸部・肩甲部の病を速やかに除くとされる。
