---
type: yoga-asana
title: "カパーラバーティ（kapālabhāti）"
description: "HYP第2章収録（クリヤー（六浄化法）） — カパーラバーティ（kapālabhāti）の実践法エントリ"
...
hyp_chapter: 2
hyp_section: The Kapala Bhati
---

# カパーラバーティ（kapālabhāti）

## 区分
**区分A — HYP確認済み**（HYP 第2章「The Kapala Bhati」）

## 読み
カパーラバーティ

## 語源
kapāla（カパーラ / 頭蓋骨）＋ bhāti（バーティ / 輝く・光る）。
直訳は「頭蓋骨を輝かせるもの」。
...
*出典: 05_Sources/HYP_Svatmarama_fulltext.md — Chapter 2, The Kapala Bhati*
